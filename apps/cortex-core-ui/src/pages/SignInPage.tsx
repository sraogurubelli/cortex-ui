      ...
      <Card.Root className="w-full max-w-md p-10 shadow-lg">
        <Layout.Vertical gapY="lg">
            ...
            <Layout.Vertical gapY="md">
              ...
              <Layout.Vertical gapY="xs">
                <Layout.Horizontal justify="between" align="center">
                  ...
                  <Link to="/signin/forgot" className="text-sm cn-text-brand-primary hover:underline">
                    Forgot password?
                  </Link>
                </Layout.Horizontal>
                <Input
          ...
          <div className="flex justify-center gap-3 flex-wrap">
            <button
              type="button"
              className="w-11 h-11 flex items-center justify-center rounded-md border cn-border-border-1 cn-bg-background-1 hover:cn-bg-background-3 transition-colors"
              aria-label="GitHub"
              title="GitHub"
